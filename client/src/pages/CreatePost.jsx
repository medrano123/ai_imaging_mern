...
const CreatePost = () => {
	...
	const handleSubmit = async (e) => {
		...
		if(form.prompt && form.photo){
			...
			alert('Please enter a prompt and enter an image');
		}
	}
  	...
  	return (
		...
		<div>
				...
				<p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
					Browse through a collection of imaginative and visually stunning images through DALL-E AI and share them with the community
				</p>
			</div>
